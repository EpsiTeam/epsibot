...
export function checkEnvironmentVariables() {
	...
	const helpDotEnv =
		" not found, make sure you created a .env file at the root of the project containing this variable. Read the README.md for more information";
	...
	if (!process.env.npm_package_version)
		throw Error(
			`${envVar} npm_package_version not found, this happens if you use directly node to start this project. Please use npm start`
		);
}
